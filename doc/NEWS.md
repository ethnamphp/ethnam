...
変更点の詳細は、 [変更点一覧](changes.md)をご覧ください。
...
「言語とエンコーディングの設定」  
 [app-setlanguage.md](app-setlanguage.md)  
「プロジェクトの国際化」  
 [i18n.md](i18n.md)  
「多次元配列」  
 [form-multiarray.md](form-multiarray.md)  
「フォームテンプレートへの変更」  
 [form_template.md](form_template.md)  
「動的フォームAPI」  
 [app-dynamicform.md](app-dynamicform.md)  
「VAR_TYPE_STRING の max, min 属性に関する詳細」  
 [form-validate-vartypestring.md](form-validate-vartypestring.md)
...
[misc-migrate_project230to250.md](misc-migrate_project230to250.md)
...
議事録は以下をご覧下さい。 2.5.0 preview4 以降に取り込まれる各機能についての具体的な方向性が決まりました。 意見などありましたら、 [メーリングリスト、IRC、フォーラム、sourceforge.jp](ethna-community.html)などでお寄せください。
...
- [2.3.x から 2.5.0への移行ガイド](misc-migrate_project230to250.md)
- [多次元配列](form-multiarray.md)
- [フォームテンプレートへの変更](form_template.md)
- [動的フォームAPI](app-dynamicform.md)
- [言語とエンコーディングの設定](app-setlanguage.md)
- [VAR_TYPE_STRING の max, min 属性に関する詳細](form-validate-vartypestring.md)
- [プロジェクトの国際化](i18n.md)
...
PEAR経由のダウンロード、wikiサービスの利用、MLの利用等の動作に変更はないはずですが、仮におかしな動作を発見した場合は、 [メーリングリスト、IRC、フォーラム、sourceforge.jp](ethna-community.html) のいずれかに御報告をお願い致します。
...
[ロードマップ](roadmap.md)から遅れに遅れ、師走はもう目前となりましたが、とうとう Ethna-2.3.0 がリリースされました。ご要望、バグ報告などぜひともお待ちしております!!

- [ダウンロード](pear/Ethna-2.3.0.tgz)

2.3.0-preview3 から機能的な変更点はありません。2.1.2 からの変更、移行方法については、古いプロジェクトのアップデート [?](cmd=edit&page=ethna-document-misc-migrate_project&refer=ethna-news.md)を参照してください。

### 2006/11/21 Ethna 2.3.0 Preview3リリース

[ロードマップ](roadmap.md)からは相当に遅れてしまいましたが、Ethna 2.3.0 Preview3をリリースしました。ご要望、バグ報告等お待ちしております。

- [ダウンロード](pear/Ethna-2.3.0-preview3.tgz)

主な変更点は下記の通りです。ずいぶん時間が経ってしまい、かなりの変更点があるので、詳細は [変更点一覧](changes.md)をご覧いただくようお願いします。
...
[ロードマップ](roadmap.md)からは遅れること4日、Ethna 2.3.0 Preview2をリリースしました。ご要望、バグ報告等お待ちしております。
...
2. プラグインシステム追加(w/ Ethna_Pluginクラス)
  ...
  - see also
    - [plugin.md](plugin.md)
    - [form-validate_with_plugin.md](form-validate_with_plugin.md)
...
初のメジャーバージョンアップとなる [Ethna 2.1.0](ethna-download.html)をリリースしました。
...
- [ダウンロード](ethna-download.html)
- [変更点一覧](changes.md)
- [ロードマップ](roadmap.md)(正式リリースまでのToDo)
...
- [アップデート方法](tutorial-install_guide.md#content_1_7)
...
詳細は [変更点一覧](ethna-changes.html#rel-0-1-3)を御覧下さい。
...
- [設定情報や定義済みアクション等を一覧する](misc-info.md)
...
- [スクリプトを1ファイルに統合する](misc-unify.md)
...
- [未定義のアクションが指定された場合に特定のアクションを実行する](app-fallbackentrypoint.md)
