...
フォームヘルパについては、 [フォームヘルパ](ethna-document-dev_guide-view-form_helper.md "ethna-document-dev\_guide-view-form\_helper (998d)") の説明も参照してください。
...
フォームヘルパで利用するフォーム定義を動的に変更したい場合は、以下の特別なメソッドを使います。使い方は [フォーム定義変更専用のヘルパメソッド](ethna-document-dev_guide-app-dynamicform.md#j5cff07b) で説明した setFormDef\_PreHelper() と全く同じです。
...
[http://ethna.jp/ethna-document-faq-dev\_guide\_faq.html#jee57430](ethna-document-faq-dev_guide_faq.md#jee57430)
