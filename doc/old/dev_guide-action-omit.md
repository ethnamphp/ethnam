...
アクションクラスが定義されていない場合、$fallback_action_nameをアクション名とみなしてアクションを実行する(($fallback_action_nameについては [未定義のアクションが指定された場合に特定のアクションを実行する](dev_guide-app-fallbackentrypoint.md)を参照してください))
