...
<title>
Auth Plugin - Ethna - PHPウェブアプリケーションフレームワーク</title>
...
<!-- ??BEGIN id:body --> [Ethna](index.html) > [ドキュメント](ethna-document.html) > [アイデア](ethna-document-ideas.html) > Auth Plugin 
## Auth Plugin [](ethna-document-ideas-auth_plugin.html#bd9e78c5 "bd9e78c5")
