...
<!-- ??BEGIN id:body --> [Ethna](index.html) > [ドキュメント](ethna-document.html) > [開発マニュアル](ethna-document-dev_guide.html) > [アプリケーションオブジェクト](ethna-document-dev_guide-appobj.html) > アプリケーションオブジェクトについて 
