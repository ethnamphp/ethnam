...
- Ethna\_Plugin\_Validator\_Mbregexp　追加 (thx: mumumu)
  ...
  - [http://ethna.jp/ethna-document-dev\_guide-form-validate.html](dev_guide-form-validate.md)
- Ethna\_Plugin\_Handle\_PearLocal　追加
  - PEARパッケージを各プロジェクト毎に管理できるプラグイン
  - [http://ethna.jp/ethna-document-dev\_guide-pearlocal.html](dev_guide-pearlocal.md)
...
- [breaking B.C.] Ethna\_Renderer追加
  ...
  - see also
    - [Ethna\_Pluginのつかいかた](dev_guide-plugin.md)
