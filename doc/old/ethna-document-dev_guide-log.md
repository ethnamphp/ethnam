...
こうして取得した Ethna\_Loggerクラスのインスタンスに対して、ログレベルとメッセージを引数として以下の形で直接指示します。エラー関連の処理については [エラー処理](dev_guide-error.md "ethna-document-dev\_guide-error (1240d)") のページも参照してください。
