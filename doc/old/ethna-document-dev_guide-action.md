# アクション定義 - Ethna - PHPウェブアプリケーションフレームワーク</title>
...
<!-- ??BEGIN id:body --> [Ethna](index.html) > [ドキュメント](ethna-document.html) > [開発マニュアル](ethna-document-dev_guide.html) > アクション定義 
## アクション定義 [](ethna-document-dev_guide-action.html#i1a2d46d "i1a2d46d")
