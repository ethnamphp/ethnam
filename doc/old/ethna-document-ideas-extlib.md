...
<title>
ethna-document-ideas-extlib- Ethna - PHPウェブアプリケーションフレームワーク</title>
...
<!-- ??BEGIN id:body --> [Ethna](index.html) > [ドキュメント](ethna-document.html) > [アイデア](ethna-document-ideas.html) > ethna-document-ideas-extlib
