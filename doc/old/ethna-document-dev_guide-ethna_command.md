# ethnaコマンドリファレンス
[アプリケーション構築手順(1)](ethna-document-tutorial-practice1.md "ethna-document-tutorial-practice1 (23d)") のページにあるように、Ethna では、プロジェクトの作成から、作成されたプロジェクトに関わる様々な操作を ethna コマンドと呼ばれるコマンドラインから行えるようになっています。
...
- [-l|--locale] (2.5.0 preview1以降)  
  ...
  - デフォルトはja\_JPです。
  - [言語とエンコーディングの設定](ethna-document-dev_guide-app-setlanguage.md "ethna-document-dev\_guide-app-setlanguage (737d)") も参照して下さい
...
詳細は、 [Ethnaプロジェクト内で PEAR パッケージを管理する](ethna-document-dev_guide-pearlocal.md "ethna-document-dev\_guide-pearlocal (858d)") を参照して下さい。
...
- [pear command ...]
  ...
  - [Ethnaプロジェクト内で PEAR パッケージを管理する](ethna-document-dev_guide-pearlocal.md "ethna-document-dev\_guide-pearlocal (858d)") も参照して下さい。
...
local/master の違いは [プラグインの説明](ethna-document-dev_guide-plugin.md "ethna-document-dev\_guide-plugin (737d)")を参照してください。
...
プラグインのパッケージを作ります。詳しくは [プラグインのパッケージを作る](ethna-document-dev_guide-pearpackage.md#k085db20 "ethna-document-dev\_guide-pearpackage (856d)")を参照してください。 このコマンドを使うには、 [PEAR\_PackageFileManager](http://pear.php.net/manual/ja/package.pear.pear-packagefilemanager.php) がインストールされている必要があります。
